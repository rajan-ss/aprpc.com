...
<form class="cart form" action="<?php echo esc_url( get_permalink() ); ?>" method="post" enctype='multipart/form-data'>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<div class="mt-10">
			<button type="submit" class="btn btn-mod btn-large btn-round single_add_to_cart_button"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
		</div>
